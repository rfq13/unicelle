...
@section('content')
    <style>
        ...
        .bg_my_voc {
            background: linear-gradient(249.42deg, #0B389C 0%, #3B6CB6 100%);
                                        ...
                                        <div class="modal-body">
                                            <div class="row align-items-center justify-content-center">
                                                <div class="col-4 text-center">
                                                    <img src="{{ my_asset('images/icon/coin.png') }} " alt=""
                                                        class="img-fluid" width="180" height="160">
                                                </div>
                                                <div class="col-6">
                                            ...
                                            <ul>
                                                <li class="py-1">
                                                    Promo eksklusif ini berlaku untuk pembelanjaan dengan minimum Rp
                                                    200.000! Promo berlaku untuk semua produk kecuali voucher, tagihan,
                                                    tiket & top-up.
                                                </li>
                                                <li class="py-1">
