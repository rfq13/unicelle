    ...
    <div class="col-md">
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="{{route('blog.edit', encrypt($ctg->id))}}">{{translate('Edit')}}</a></li>
                                                <li><a onclick="confirm_modal('{{route('blog.destroy', $ctg->id)}}');">{{translate('Hapus')}}</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="{{ route('blog.store-ctg') }}" method="post">
                    @csrf
                ...
                <div class="modal-body">
                    <input class="form-control form-control-lg" type="text" name="name" placeholder="nama kategori">
                </div>
