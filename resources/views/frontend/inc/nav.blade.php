<nav class="navbar navbar-expand-lg bg-white navbar-light">
    ...
    <div class="btn btn-search mr-3 ml-3">
        ...
        <a href="{{ route('wishlists.index') }}" style="color:black">
            ...
            class="fa fa-heart-o icon-footer" aria-hidden="true"></i>
        </a>

        <a href="{{ route('cart') }}">
            <i class="ml-3 mr-3"id="" type="button"
            aria-haspopup="true" aria-expanded="false">
            <img style="width:20px; height:20px ml-2 mr-2"
    ...
    <div class="btn-group" role="group">
            <i class="fa fa-user-o icon-footer"
            id="btnGroupDrop1" type="button"
        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
        
        <div class="dropdown-menu pb-0" style="width: 240px; border-radius: 20px; top: 70px; left: -80px; border: 2px #000;" aria-labelledby="btnGroupDrop1">
            @auth
            <div class="row">
