...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
	...
	Route::group(['prefix' => 'products'], function () {
		Route::get('/', 'ProductController@admin_products')->name('products.admin');
	...
	Route::put('edit-kategori-blog/{id}','blogController@update_kategori_blog')->name('blog.edit-ctg');
	...
	//log
	Route::get('/log_admin', 'LogController@index')->name('log.index');
